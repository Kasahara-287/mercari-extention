...
2,「無言取引NG」等の文言がなかった場合に無言取引等に関する文章の記載は一切しないでください。「無言取引NG」等の文言がないというのはリスクにはなりません。またそれらの文言はないのが当たり前であるため、ないからと言って危険度を下げる、またはそれについての記述はしないでください。また「ほかにもいろいろ出品しています」などは他サイトへの出品を意図しているものではないためリスクに記述しないでください。
...
2,危険度は基本低めで設定してください。
3,できるだけ詳しく記載してください。
以下の[]内にある文章に似たものが使用されていた場合は危険度を挙げてください。また[]のかにある文は"詐欺によく使われる文"と定義しました。
[
「返品・返金は一切受け付けません」
「動作確認していませんが動くと思います」
「支払いは外部アプリでお願いします」
...
詐欺によく使われる文： [前述した詐欺公文に似た文章があれば箇条書きで列挙](出力した文字数が枠組みに合うようにうまく改行してくださいまた「」を消してください)
