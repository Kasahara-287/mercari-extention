...
2,危険度は基本低めで設定してください。
3,できるだけ詳しく記載してください。
以下の[]で囲まれてる文章が詐欺によく使われている文章です。また詐欺っぽいと判断した場合追加してください。これを詐欺によく使われる文と定義しました。詐欺構文が少しでも含まれている場合はそれについて記述してください。また含まれた場合は危険度にも反映させてください。
[
「早い者勝ち！今だけ○○円！」
「事情があって急いで売ります」
「新品同様！一度も使用していません！」
...
詐欺によく使われる文： [箇条書きで詐欺構文を列挙](出力した文字数が枠組みに合うようにうまく改行してくださいまた「」を消してくださいまた・で列挙してください)
